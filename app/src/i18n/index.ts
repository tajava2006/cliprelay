...
const en: Messages = {
  ...
  'main.logout': 'Logout',
  'main.compose.placeholder': 'Type text to send to your other devices',
  'main.compose.send': 'Send',
  'main.compose.fail': 'Send failed',
  'main.connlog': 'Connection Log',
  'main.connlog.empty': 'No events yet',
  'toast.clipboard.concealed': 'Sensitive — kept out of history',
...
const ko: Messages = {
  ...
  'main.history': '히스토리',
  'main.logout': '로그아웃',
  'main.compose.placeholder': '다른 기기로 보낼 텍스트 입력',
  'main.compose.send': '보내기',
  'main.compose.fail': '전송 실패',
  'main.connlog': '연결 로그',
  'main.connlog.empty': '아직 기록된 이벤트 없음',
  'toast.clipboard.concealed': '민감 정보 — 히스토리 제외',
