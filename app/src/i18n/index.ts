...
const en: Messages = {
  ...
  'login.qr.tap_amber': 'Tap the QR to use Amber on this device',
  'login.bunker.scan': 'Scan QR with camera',
  'login.bunker.scan_hint': 'Scan the bunker URL QR shown by your signer app',
  'login.scan.cancel': 'Cancel',
  'login.scan.error.permission': 'Camera permission denied — allow it in system settings.',
  'login.scan.error.invalid': 'Not a bunker:// QR code.',
  'login.retry': 'Retry',
...
const ko: Messages = {
  ...
  'login.qr.tap_amber': 'QR을 탭하면 이 기기의 Amber로 연결합니다',
  'login.bunker.scan': '카메라로 QR 스캔',
  'login.bunker.scan_hint': '서명 앱이 보여주는 bunker URL QR을 스캔하세요',
  'login.scan.cancel': '취소',
  'login.scan.error.permission': '카메라 권한이 거부됐습니다 — 시스템 설정에서 허용해 주세요.',
  'login.scan.error.invalid': 'bunker:// QR 코드가 아닙니다.',
  'login.retry': '다시 시도',
...
const ja: Messages = {
  ...
  'login.qr.tap_amber': 'QRをタップするとこの端末のAmberに接続します',
  'login.bunker.scan': 'カメラでQRをスキャン',
  'login.bunker.scan_hint': '署名アプリが表示するbunker URLのQRをスキャン',
  'login.scan.cancel': 'キャンセル',
  'login.scan.error.permission': 'カメラ権限が拒否されました — 設定で許可してください。',
  'login.scan.error.invalid': 'bunker:// のQRコードではありません。',
  'login.retry': '再試行',
